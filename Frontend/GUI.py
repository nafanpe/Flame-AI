...
class ChatSection(QWidget):
    def __init__(self):
        ...
        movie = QMovie(GraphicsDirectoryPath('Flame.gif'))
        max_gif_size_W = 480
        max_gif_size_H = 270
        ...
        self.setStyleSheet("""
            ...
            QScrollBar::up_arrow:vertical, QScrollbar::down-arrow:vertical {
            border: none;
            background: none;
            color: none;               
            }
    ...
    def toggle_icon(self, event=None):
        if self.toggled:
            self.lead_icon(GraphicsDirectoryPath('voice.png'), 60, 60)
            MicButtonInitialized()
        else:
            self.lead_icon(GraphicsDirectoryPath('mic.png'), 60, 60)
            MicButtonClosed()
